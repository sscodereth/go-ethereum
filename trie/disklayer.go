...
func (dl *diskLayer) Update(blockHash common.Hash, blockNumber uint64, nodes map[string]*cachedNode) *diffLayer {
	return newDiffLayer(dl, blockHash, blockNumber, nodes)
}
